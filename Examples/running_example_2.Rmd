---
title: "Supplement for Interim Analysis and Multiple Testing Strategy for Running example 2"
date: "`r Sys.Date()`"
output:
...
# Time limit in plot
Tmax_atPlot   <- 60
# Study specific parameter for multiple testing procedure. This parameter will define recycling from ORR to CR, and from PFS to OS
mtParam       <- 1
